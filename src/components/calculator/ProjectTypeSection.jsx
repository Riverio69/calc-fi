...
export const PROJECT_TYPES = [
  { id: 'mobile', label: 'Mobiilisovellus', price: 8000 },
  { id: 'web', label: 'Verkkosivusto / laskeutumissivu', price: 2000 },
  { id: 'ecommerce', label: 'Verkkokauppa', price: 5000 },
  { id: 'platform', label: 'Verkkopalvelu / alusta', price: 8000 },
  { id: 'saas', label: 'SaaS-tuote', price: 9000 },
];
          ...
          return (
            ...
            >
              ...
              <span className={`block text-xs mt-0.5 ${isActive ? 'text-[#a3e635]' : 'text-[#555]'}`}>
                alkaen €{type.price.toLocaleString()}
              </span>
            </motion.button>
          );
        })}
